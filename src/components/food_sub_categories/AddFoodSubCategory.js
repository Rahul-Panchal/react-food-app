...
import {handleSubmitAction, updateInputDetails} from '../../redux/features/foodSubCategorySlice';

const AddFoodSubCategory = (props) => {
    ...
    useEffect(()=>{
      ...
      console.log('food category Id :: ' + food_category_id);
              ...
              <form className="user" onSubmit={handleSubmit(onSubmit)}>  
                ...
                <div className="form-group row">
                  ...
                  <div className="col-sm-3">
                    ...
                    <select className="form-control" {...register('food_category_id', { required: true })} name="food_category_id" onChange={(e)=>dispatch(updateInputDetails({[e.target.name] : e.target.value}))} value={(food_category_id) ? food_category_id : formData.food_category_id} required>
...
export default AddFoodSubCategory;