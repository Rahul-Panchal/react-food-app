          ...
          <form className="user" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="form-group row">
              ...
              <div className="col-sm-3">
                <div className="custom-file">
                  ...
                  <input type="file" className="custom-file-input" id="customFile" {...register('product_image', { required: false})} name="product_image" onChange={(e) => dispatch(handleImageChange({ [e.target.name]: e.target.files[0] }))} />
              ...
              <div className="col-sm-3">
                <img src={`http://localhost:8081/images/product_images/`+foodProductDetail.product_image}  alt={foodProductDetail.product_image} width="75" height="75"/>
              </div>
            ...
            <div className="form-group row">
              ...
              <div className="col-sm-3">
                ...
                {product_image ? <img src={preview} alt={preview} width="75" height="75"/> : <img src={`http://localhost:8081/images/product_images/`+foodProductDetail.product_image}  alt={foodProductDetail.product_image} width="75" height="75"/> }
              </div>
            </div>
