...
import { clearFormData, handleUpdateAction, updateInputDetails, handleImageChange, comparePassword, retrieveAll, retrieveOne, removeOne, getCountriesList, getStateList, getStateCities, getCitiesList, getRestaurantStatusList, getUserTypesList } from '../../redux/features/restaurantSlice';
          ...
          <form className="user" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="form-group row">
              ...
              <div className="col-sm-3">
                ...
                <select className="form-control" {...register('owner_id', { required: true})}  name="owner_id" onChange={(e) => dispatch(updateInputDetails({ [e.target.name]: e.target.value }))} value={restaurantDetail.owner_id._id} required>
            ...
            <div className="form-group row">
              ...
              <div className="col-sm-9">
                <textarea className="form-control" placeholder="Restaurant Description" {...register('restaurant_desc', { required: false})} name="restaurant_desc" onChange={(e) => dispatch(updateInputDetails({ [e.target.name]: e.target.value }))} value={restaurantDetail.restaurant_desc} required />
              </div>
            </div>
            ...
            <div className="form-group row">
              ...
              <div className="col-sm-3">
                <input type="text" className="form-control" placeholder="Restaurant Opening Time" {...register('restaurant_opening_time', { required: false})}  name="restaurant_opening_time" onChange={(e) => dispatch(updateInputDetails({ [e.target.name]: e.target.value }))} value={restaurantDetail.restaurant_opening_time} required />
              </div>
              <div className="col-sm-3"><label><b>Restaurant Closing Time</b></label></div>
              <div className="col-sm-3">
                <input type="text" className="form-control" placeholder="Restaurant Closing Time" {...register('restaurant_closing_time', { required: false})}  name="restaurant_closing_time" onChange={(e) => dispatch(updateInputDetails({ [e.target.name]: e.target.value }))} value={restaurantDetail.restaurant_closing_time} required />
              </div>
            </div>
            ...
            <div className="form-group row">
              ...
              <div className="col-sm-3">
                <input type="text" className="form-control" placeholder="Email Id" {...register('email_id', { required: false})} name="email_id" onChange={(e) => dispatch(updateInputDetails({ [e.target.name]: e.target.value }))} value={restaurantDetail.email_id} required />
              </div>
              <div className="col-sm-3"><label><b>Contact No.</b></label></div>
              <div className="col-sm-3">
                <input type="text" className="form-control" placeholder="Contact No." {...register('contact_no', { required: false})} name="contact_no" onChange={(e) => dispatch(updateInputDetails({ [e.target.name]: e.target.value }))} value={restaurantDetail.contact_no} required />
              </div>
            </div>
            ...
            <div className="form-group row">
              ...
              <div className="col-sm-3">
                ...
                <select className="form-control" {...register('state_id', { required: false})} name="state_id" onChange={(e) => dispatch(getStateCities(e.target.value))} value={restaurantDetail.state_id} required>
              ...
              <div className="col-sm-3">
                <select className="form-control" {...register('city_id', { required: false})}  name="city_id" onChange={(e) => dispatch(updateInputDetails({ [e.target.name]: e.target.value }))} value={restaurantDetail.city_id} required>
            ...
            <div className="form-group row">
              ...
              <div className="col-sm-3">
                <select className="form-control" {...register('country_id', { required: false})}  name="country_id" onChange={(e) => dispatch(updateInputDetails({ [e.target.name]: e.target.value }))} value={restaurantDetail.country_id} required>
              ...
              <div className="col-sm-3">
                <input type="text" className="form-control" placeholder="Pin Code" {...register('pin_code', { required: false})} name="pin_code" onChange={(e) => dispatch(updateInputDetails({ [e.target.name]: e.target.value }))} value={restaurantDetail.pin_code} required />
              </div>
            </div>
            ...
            <div className="form-group row">
              <div className="col-sm-3"><label><b>Restaurant Status</b></label></div>
                  <div className="col-sm-3">
                    <select className="form-control" {...register('is_active', { required: false })} name="is_active" onChange={(e)=>dispatch(updateInputDetails({[e.target.name] : e.target.value}))} value={restaurantDetail.is_active}>
                      <option>Select Restaurant Status</option>
                      {
                        (restaurantStatusList) ?
                          (restaurantStatusList.map((data) =>
                            // (user_type == data.id) ?
